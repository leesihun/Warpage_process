...
def create_comprehensive_advanced_analysis(folder_data, figsize=(20, 24)):
    ...
    # 고급 분석 그래프들 생성 / Generate advanced analysis plots
    plot_configs = [
        ('violin_plots', 'Distribution Analysis - Violin Plots'),
        ('cdf_plots', 'Cumulative Distribution Functions'), 
        ('qq_plots', 'Q-Q Plots vs Normal Distribution'),
        ('percentile_analysis', 'Percentile Analysis'),
        ('process_capability', 'Process Capability Analysis'),
        ('skewness_kurtosis', 'Distribution Shape Analysis'),
        ('gradient_analysis', 'Spatial Gradient Analysis'),
        ('contour_plots', 'Contour Analysis'),
        ('cross_sectional_profiles', 'Cross-Sectional Profiles'),
        ('hotspot_analysis', 'Hotspot Detection'),
        ('control_charts', 'Statistical Process Control'),
        ('correlation_analysis', 'Inter-File Correlation'),
        ('pca_visualization', 'Principal Component Analysis'),
        ('clustering_visualization', 'Pattern Clustering'),
        ('stability_metrics', 'Process Stability Metrics'),
        ('heatmap_overlays', 'Statistical Overlays'),
        ('fourier_analysis', 'Frequency Domain Analysis')
    ]
